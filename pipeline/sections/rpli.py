"""RPLI — thin wrapper around the shared PLI/RPLI extraction logic."""
from pipeline.sections import _pli_rpli_common as common

DIVISION_SHEET = "RPLI Division Distribution"
DETAIL_SHEET = "RPLI Detail"


def validate(section_cfg, path, month_iso):
    return common.validate("rpli", section_cfg, path, month_iso, DIVISION_SHEET, DETAIL_SHEET)
